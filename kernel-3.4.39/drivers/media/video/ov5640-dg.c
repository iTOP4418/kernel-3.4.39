...
//add by dg 2015-09-14
extern void camera_common_vin_setup_io(int module, bool force);
extern void back_camera_power_enable(bool enable);
...
struct ov5640_priv {
    ...
    struct media_pad                    pad;  //add by dg 2015-09-14
...
static int ov5640_init(struct v4l2_subdev *sd, u32 val)
{
	...
	//ov5640_sensor_s_single_af(sd);
        ...
        INFO_BLUE("ov5640 device probed success on %s.......\n",__func__);
